# Hero Rotation – Webflow Integration

Particle logo animation with continuous rotation. Three.js only (no GSAP).

## What's included

- **heroRotation.js** – Animation script (upload to Webflow Assets or your CDN)
...
2. Upload `heroRotation.js` and your logo image.
...
```html
<div id="hero-rotation-container" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; min-height: 100vh; pointer-events: none;"></div>
<script src="YOUR_heroRotation.js_URL"></script>
<script>
  (function() {
    initHeroRotation({
      container: document.getElementById('hero-rotation-container'),
...
- **rotationSpeed**: Rotation speed per frame. Default: 0.0025
